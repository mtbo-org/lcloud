...
public abstract class DiscoveryService<
  ...
  final FileLineLogger logger =
      new FileLineLogger(Logger.getLogger(DiscoveryService.class.getName()));
        ...
        .flatMap(
            (b) ->
                connection
                            ...
                            tuple2Mono
                                ...
                                .map(
                                    tuple -> {
                                      ...
                                      logger.fine(
                                          "                                                                       2 2 2 2 2 2 2 2 2 2 Packet received; packet: "
                                              + new String(
                    ...
                    .onErrorResume(
                        throwable -> {
                          logger.finer("Exception caught on 2 2 2 2 2 2: " + throwable, throwable);
                          return Mono.empty();
                        }))
